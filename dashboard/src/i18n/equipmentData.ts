  ...
  "th": {
    ...
    "items": {
      "rack-a": {
        ...
        "specs": [
          {
            "label": "ความสูงตู้แร็ค",
            "value": "42U (2,000mm x 600mm x 1,070mm)"
          },
          {
            "label": "หน่วยประมวลผล",
            "value": "Dual Intel Xeon Platinum / AMD EPYC"
          },
          {
            "label": "หน่วยความจำ",
            "value": "512GB ECC Registered DDR5"
          },
          {
            "label": "พาวเวอร์ซัพพลาย",
            "value": "Dual 1600W Titanium 96% Efficiency"
          }
        ],
        "telemetry": [
          {
            "label": "กำลังไฟฟ้า IT Load",
            "value": "959.3 W",
            "color": "text-cyan-400"
          },
          {
            "label": "อุณหภูมิลมจ่าย (Supply)",
            "value": "21.5 °C",
      ...
      "cooling": {
        ...
        "image": "/assets/equipment/cooling.jpg",
        "specs": [
          {
            "label": "พิกัดการทำความเย็น",
            "value": "60 kW Net Sensible Cooling"
          },
          {
            "label": "พัดลมระบายอากาศ",
            "value": "Variable Speed EC Fans (Modulating)"
          },
          {
            "label": "อัตราการไหลน้ำเย็น",
            "value": "Chilled Water 1.8 L/s @ 7°C"
          },
          {
            "label": "อุณหภูมิลมเป่าจ่าย",
            "value": "20.0°C - 22.0°C Precision Control"
          }
        ],
        "telemetry": [
          {
          ...
          {
            "label": "อุณหภูมิดูดกลับ (Exhaust)",
            "value": "38.2 °C",
            "color": "text-rose-400"
          },
          {
            "label": "ค่าผลต่างอุณหภูมิ (ΔT)",
            "value": "16.7 °C",
            "color": "text-amber-400"
          },
          {
            "label": "ความเร็วพัดลม EC Fan",
            "value": "62 %",
            "color": "text-emerald-400"
          }
        ],
      ...
      "rack-b": {
        ...
        "specs": [
          ...
          {
            "label": "ฮาร์ดแวร์พิเศษ",
            "value": "AI Inference Accelerator Clusters"
          },
          {
            "label": "เครือข่ายความเร็วสูง",
            "value": "Dual 100GbE QSFP28 Uplinks"
          },
          {
            "label": "พาวเวอร์ซัพพลาย",
            "value": "Dual 1600W Titanium 96% Efficiency"
      ...
      "ups": {
        ...
        "image": "/assets/equipment/ups.jpg",
        "specs": [
          {
            "label": "ประเภทระบบสำรองไฟ",
            "value": "True Online Double-Conversion (VFI)"
          },
          {
            "label": "กำลังไฟพิกัด",
            "value": "48 kW / 48 kVA N+1 Modular"
          },
          {
            "label": "ชนิดแบตเตอรี่",
            "value": "Modular Li-Ion / VRLA Battery Trays"
          },
          {
            "label": "ประสิทธิภาพพลังงาน",
            "value": "97.5% in Double Conversion"
          }
        ],
        "telemetry": [
          {
            "label": "ระดับประจุแบตเตอรี่",
            "value": "100 %",
            "color": "text-emerald-400"
          },
          {
            "label": "ระยะเวลาจ่ายไฟสำรอง",
            "value": "28 นาที @ Full Load",
            "color": "text-cyan-400"
          },
          {
            "label": "แรงดันไฟอินพุต",
            "value": "400V 3-Phase 50Hz",
            "color": "text-slate-300"
          },
          {
            "label": "เวลาถ่ายโอนไฟ (Transfer)",
            "value": "0 มิลลิวินาที (Zero Break)",
            "color": "text-emerald-400"
          }
        ],
      ...
      "pdu": {
        ...
        "image": "/assets/equipment/pdu.jpg",
        "specs": [
          {
            "label": "รูปแบบการติดตั้ง",
            "value": "0U Vertical Tool-less Mount"
          },
          {
            "label": "พิกัดกระแสไฟฟ้า",
            "value": "32A 230V Single-Phase (Feed A & B)"
          },
          {
            "label": "จำนวนเต้ารับ",
            "value": "24x IEC C13 + 6x IEC C19 Locking"
          },
          {
            "label": "ความแม่นยำของมิเตอร์",
            "value": "Billing-Grade ±1% True RMS"
          }
        ],
        "telemetry": [
          {
            "label": "กระแสไฟสาย Feed A",
            "value": "3.2 A",
            "color": "text-cyan-400"
          },
          {
            "label": "กระแสไฟสาย Feed B",
            "value": "2.8 A",
            "color": "text-emerald-400"
          },
          {
          ...
          {
            "label": "ระยะเผื่อความปลอดภัย",
            "value": "+1,162 W (NEC 80% Safe)",
            "color": "text-emerald-400"
          }
        ],
      ...
      "containment": {
        ...
        "standard": "ASHRAE TC 9.9 Thermal Guidelines",
        "image": "/assets/equipment/containment.jpg",
        "specs": [
          {
            "label": "วัสดุแผงกั้นเพดาน",
            "value": "Light-transmitting Polycarbonate"
          },
          {
            "label": "ประตูทางเดิน",
            "value": "Dual Sliding Glass with Magnetic Seals"
          },
          {
            "label": "การกักลมรั่วไหล",
            "value": "Air Leakage Rate < 1.0%"
          },
          {
            "label": "ไฟส่องสว่างนำทาง",
            "value": "Smart LED Floor Guidance Strip"
          }
        ],
        "telemetry": [
          {
            "label": "อุณหภูมิทางเดินลมเย็น",
            "value": "21.5 °C",
            "color": "text-sky-400"
          },
          {
            "label": "อุณหภูมิทางเดินลมร้อน",
            "value": "38.2 °C",
            "color": "text-rose-400"
          },
          {
            "label": "อัตราลมปะปน (Mixing)",
            "value": "0.0 % (สมบูรณ์แบบ)",
            "color": "text-emerald-400"
          },
          {
            "label": "พลังงานแอร์ที่ประหยัดได้",
            "value": "35 %",
            "color": "text-emerald-400"
          }
        ],
    ...
    "items": {
      ...
      "cooling": {
        ...
        "specs": [
          ...
          {
            "label": "Blower Technology",
            "value": "Modulating Variable Speed EC Fans"
          },
          {
            "label": "Chilled Water Flow",
            "value": "1.8 L/s @ 7°C Entering Water"
          },
          {
            "label": "Supply Air Target",
            "value": "20.0°C - 22.0°C Precision Window"
          }
        ],
        "telemetry": [
          {
      ...
      "rack-b": {
        ...
        "specs": [
          ...
          {
            "label": "Accelerated Hardware",
            "value": "AI GPU Inference Clusters"
          },
          {
      ...
      "ups": {
        ...
        "specs": [
          ...
          {
            "label": "Double-Conversion Efficiency",
            "value": "97.5% Continuous"
          }
        ],
        "telemetry": [
          {
          ...
          {
            "label": "Reserve Runtime",
            "value": "28 Minutes @ Rated Load",
            "color": "text-cyan-400"
          },
          {
            "label": "Grid Utility Voltage",
            "value": "400V 3-Phase 50Hz",
            "color": "text-slate-300"
          },
          {
            "label": "Transfer Time",
            "value": "0 ms (Seamless Inverter)",
            "color": "text-emerald-400"
          }
        ],
      ...
      "pdu": {
        ...
        "specs": [
          {
            "label": "Mounting Profile",
            "value": "0U Vertical Tool-less Mount"
          },
          {
            "label": "Branch Circuit Capacity",
            "value": "32A 230V Single-Phase (Feed A & B)"
          },
          {
            "label": "Receptacle Density",
            "value": "24x IEC C13 + 6x IEC C19 Locking"
          },
          {
        ...
        "telemetry": [
          {
            "label": "Feed A Current Draw",
            "value": "3.2 A",
            "color": "text-cyan-400"
          },
          {
            "label": "Feed B Current Draw",
            "value": "2.8 A",
            "color": "text-emerald-400"
          },
          {
          ...
          {
            "label": "Continuous Safety Margin",
            "value": "+1,162 W (NEC 80% Safe)",
            "color": "text-emerald-400"
          }
        ],
      ...
      "containment": {
        ...
        "specs": [
          {
            "label": "Ceiling Panel Material",
            "value": "Light-transmitting Polycarbonate"
          },
          {
            "label": "Entry Barrier",
            "value": "Dual Sliding Glass Doors with Magnetic Seals"
          },
          {
            "label": "Air Infiltration Seal",
            "value": "Air Leakage Rate < 1.0%"
          },
          {
            "label": "Guidance Lighting",
            "value": "Smart LED Floor Guidance Strip"
          }
        ],
        "telemetry": [
          ...
          {
            "label": "Hot Aisle Exhaust Temp",
            "value": "38.2 °C",
            "color": "text-rose-400"
          },
          {
            "label": "Air Mixing Ratio",
            "value": "0.0 % (Optimal Isolation)",
            "color": "text-emerald-400"
          },
          {
